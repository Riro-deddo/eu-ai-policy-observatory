...
export interface PolicyMapNode { id: string; entityId: string; kind: PolicyMapNodeKind; title: string; date: string; level: string; stage: string; policyIds: string[]; href: string }
export interface PolicyMapEdge { id: string; source: string; target: string; sourceEntityId: string; targetEntityId: string; sourceKind: PolicyMapNodeKind; targetKind: PolicyMapNodeKind; type: string; basis: 'official' | 'analytical'; rationale: string | null; evidence: PolicyMapEvidence | null }
