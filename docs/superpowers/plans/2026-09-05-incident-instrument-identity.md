...
- Review scope is title/record-level only, not every official field or classification. Credit the correction to Codex in notes/ledger while preserving prior researcher and candidate decision-review attribution.
