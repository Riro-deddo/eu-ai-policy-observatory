...
A later four-record correction on 6 September admitted the RSB opinion package, ECB technical working document, Council ADD 1 statements and original July GPAI draft annex using exact dated manifestations and retained caveats. At that checkpoint the corpus contained 171 `verified` and 15 `legacy_review_pending` documents across the same 186 routes. Its chronological ledger is `research/migrations/2026-09-06-four-evidence-admissions.json`.

The bounded six-record evidence update on 6 September admitted the real complete high-risk-guidelines consultation work and upgraded its three existing section records after full readiness and publication gates. It also added limited official evidence to three retained records without partially extending or admitting them. At that checkpoint the corpus contained 175 `verified` and 12 `legacy_review_pending` documents across 187 routes; all 186 prior routes and all 171 previously verified document bytes remained preserved. Its chronological ledger is `research/migrations/2026-09-06-six-record-evidence-update.json`.

The subsequent seven-record evidence-admission batch on 6 September upgraded six 2022 Council Presidency texts using ST 15322/24 Annex 6 evidence of later disclosure on 28 October 2024 and upgraded C(2023) 3215 using the JRC's explicit 22 May 2023 publication statement. Original Council issue dates remain separate from the later disclosure date. C(2023) 3215 now records its current `repealed` status from C(2025) 3871 Article 4 without inventing an operative repeal date. At that checkpoint the corpus contained 182 `verified` and 5 `legacy_review_pending` documents across the same 187 routes. The retained records are ST 10069/22, ST 12206/22 INIT, C(2025) 3871 and the two July 2025 GPAI training records. The unsupported INIT-to-ST 11124 edge is retained as pending; a distinct evidenced REV 1-to-ST 11124 edge preserves the supported lineage while the INIT identity conflict remains explicit. Its chronological ledger is `research/migrations/2026-09-06-seven-evidence-admissions.json`. Pending state does not mean an official document is fictitious or that its prior official-record checks failed. Public UI/build verification and remote publication checks remain separate release gates.

The subsequent ST 10069 admission on 6 September completes that record using Council access requests 22/1313 and 22/1307, both recording public-access replies on 20 June 2022. Its issue date remains 15 June; documented access is not first-ever publication. The current local corpus contains 183 `verified` and 4 `legacy_review_pending` documents across the same 187 routes. The original July C(2025)5235 ANNEX was also recovered on an eligible Commission host, narrowing both GPAI holds to the still-incomplete approval-parent publication evidence. ST 12206 INIT retains its exact-version conflict; C(2025)3871 retains its publication-day gap. No partial extension, new source exception or schema change was used. See `research/migrations/2026-09-06-st10069-evidence-admission.json`. These are local data results; website build and remote publication remain separate gates.
...
On the current corpus, the standalone all-document preflight remains nonzero because 4 retained legacy routes have not completed the extension. The continuation's historical checkpoint expected 131 checked and 105 ready; its measured result remains recorded in that immutable ledger. This does not indicate a production-build regression: the compatibility gate validates the complete extension on reviewed records while preserving exact baseline ID/slug routes for pending legacy records. The later six-record update resolved the three draft-guideline missing-parent holds by admitting the evidenced whole consultation work and three official `part_of` relationships; the superseded retained-route notices were removed only after the four-document candidate gate passed.
